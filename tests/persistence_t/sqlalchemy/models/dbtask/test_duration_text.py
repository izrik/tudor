...
class TaskDurationTextTest(unittest.TestCase):
    ...
    def test_no_duration_yields_empty(self):
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=None)
    ...
    def test_single_minute_yields_special_case(self):
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=1)
    ...
    def test_minutes_yields_text_0(self):
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=0)
    ...
    def test_minutes_yields_text_2(self):
        ...
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=2)
    ...
    def test_minutes_yields_text_3(self):
        ...
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=3)
    ...
    def test_minutes_yields_text_4(self):
        ...
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=4)
    ...
    def test_minutes_yields_text_12345(self):
        ...
        # given
        t1 = self.pl.DbTask('t1', expected_duration_minutes=12345)
