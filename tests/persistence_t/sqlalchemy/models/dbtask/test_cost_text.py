...
class TaskCostTextTest(unittest.TestCase):
    ...
    def test_no_duration_yields_empty(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost=None)
    ...
    def test_single_whole_number(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost=Decimal(1))
    ...
    def test_single_cents_digit(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost=Decimal(1.1))
    ...
    def test_extra_digits(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost=Decimal(1.1234))
    ...
    def test_extra_digits_round_up(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost=Decimal(1.9876))
    ...
    def test_export_str_extra_digits(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost='1.1234')
    ...
    def test_export_str_extra_digits_round_up(self):
        # given
        t1 = self.pl.DbTask('t1', expected_cost='1.9876')
