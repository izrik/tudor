...
class DbAttachmentMakeChangeTest(PersistenceLayerTestBase):
    ...
    def test_setting_id_sets_id(self):
        ...
        # when
        self.attachment.make_change(AttachmentBase.FIELD_ID, Changeable.OP_SET,
                                    1)
        # then
    ...
    def test_adding_id_raises(self):
        ...
        self.assertRaises(
            ...
            AttachmentBase.FIELD_ID, Changeable.OP_ADD, 1)
    ...
    def test_removing_id_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_ID, Changeable.OP_REMOVE, 1)
    ...
    def test_changing_id_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_ID, Changeable.OP_CHANGING, 1)

    def test_setting_path_sets_path(self):
        # precondition
        self.assertEqual('attachment', self.attachment.path)
        # when
        self.attachment.make_change(AttachmentBase.FIELD_PATH,
                                    Changeable.OP_SET, 'a')
        # then
    ...
    def test_adding_path_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_PATH, Changeable.OP_ADD, 'a')
    ...
    def test_removing_path_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_PATH, Changeable.OP_REMOVE, 'a')
    ...
    def test_changing_path_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_PATH, Changeable.OP_CHANGING, 'a')

    def test_setting_description_sets_description(self):
        # precondition
        self.assertIsNone(self.attachment.description)
        # when
        self.attachment.make_change(AttachmentBase.FIELD_DESCRIPTION,
                                    Changeable.OP_SET, 'a')
        # then
    ...
    def test_adding_description_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_DESCRIPTION, Changeable.OP_ADD, 'a')
    ...
    def test_removing_description_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_DESCRIPTION, Changeable.OP_REMOVE, 'a')
    ...
    def test_changing_description_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_DESCRIPTION, Changeable.OP_CHANGING, 'a')

    def test_setting_timestamp_sets_timestamp(self):
        # precondition
        self.assertIsNone(self.attachment.timestamp)
        # when
        self.attachment.make_change(AttachmentBase.FIELD_TIMESTAMP,
    ...
    def test_adding_timestamp_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_TIMESTAMP, Changeable.OP_ADD, 'b')
    ...
    def test_removing_timestamp_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_TIMESTAMP, Changeable.OP_REMOVE, 'b')
    ...
    def test_changing_timestamp_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_TIMESTAMP, Changeable.OP_CHANGING, 'b')

    def test_setting_filename_sets_filename(self):
        # precondition
        self.assertIsNone(self.attachment.filename)
        # when
        self.attachment.make_change(AttachmentBase.FIELD_FILENAME,
                                    Changeable.OP_SET, 'a')
        # then
    ...
    def test_adding_filename_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_FILENAME, Changeable.OP_ADD, 'a')
    ...
    def test_removing_filename_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_FILENAME, Changeable.OP_REMOVE, 'a')
    ...
    def test_changing_filename_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_FILENAME, Changeable.OP_CHANGING, 'a')
    ...
    def test_setting_task_sets_task(self):
        ...
        # when
        self.attachment.make_change(AttachmentBase.FIELD_TASK,
    ...
    def test_adding_task_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_TASK, Changeable.OP_ADD, task)
    ...
    def test_removing_task_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_TASK, Changeable.OP_REMOVE, task)
    ...
    def test_changing_task_raises(self):
        ...
        self.assertRaises(
            ValueError,
            self.attachment.make_change,
            AttachmentBase.FIELD_TASK, Changeable.OP_CHANGING, task)
