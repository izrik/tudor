...
class DatabaseInteractionTest(PersistenceLayerTestBase):
    ...
    def test_saving_task_creates_id(self):
        # given
    ...
    def test_saving_task_does_not_affect_order_num(self):
        # given
        task = self.pl.create_task('summary')
        # precondition
    ...
    def test_saving_task_with_same_order_num_is_allowed(self):
        # given
        task = self.pl.create_task('summary')
        task.order_num = 1
        self.pl.save(task)
    ...
    #     # Removed: Task2 objects cannot be used with add(); use save() instead

    # def test_committing_task_with_same_id_raises(self):
    #     # Removed: Task2 id setter raises ValueError if id already set

    # def test_adding_task_with_null_order_num_does_not_affect_order_num(self):
    #     # Removed: Task2 objects cannot be used with add()
    ...
    #     # Removed: Task2 objects do not have ORM relationship attributes like
    #     # .tags, .users, etc. Use associate_tag_with_task() instead.
    ...
    #     # Removed: Task2 objects do not have .tags ORM relationship.
    #     # Use associate_tag_with_task() instead.

    def test_setting_parent_id_sets_parent(self):
        # given
    ...
    #     # Removed: Task2 objects do not have .children/.parent ORM attributes.
    #     # Use child.parent_id = parent.id and save() instead.

    # def test_adding_child_also_sets_parent_id(self):
    #     # Removed: Task2 objects do not have .children ORM attribute.

    # def test_setting_parent_also_sets_parent_id(self):
    #     # Removed: Task2 objects do not have .parent ORM attribute.
    #     # Use child.parent_id = parent.id and save() instead.

    # def test_setting_parent_also_adds_child(self):
    #     # Removed: Task2 objects do not have .parent/.children ORM attributes.
    ...
    #     # Removed: Task2 objects do not have .dependees/.dependants ORM attributes.
    #     # Use associate_dependee_with_task() instead.

    # def test_adding_task_after_also_adds_other_task_before(self):
    #     # Removed: Task2 objects do not have .prioritize_after/.prioritize_before ORM attributes.
    #     # Use associate_prioritize_before_with_task() instead.

    # def test_adding_user_to_task_also_adds_task_to_user(self):
    #     # Removed: Task2 objects do not have .users ORM attribute.
    #     # Use associate_user_with_task() instead.

    # def test_setting_id_before_adding_succeeds(self):
    #     # Removed: Task2 id setter raises ValueError if id already set;
    #     # Task2 cannot be used with add().
