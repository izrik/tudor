...
class PaginatedTasksTest(PersistenceLayerTestBase):
    def setUp(self):
        ...
        self.pl.associate_tag_with_task(self.t4.id, self.tag1.id)
    ...
    def test_get_paginated_tasks_filtered_by_tag_tag1_page_1(self):
        ...
        self.assertIn(items[0].id, {self.t2.id, self.t3.id, self.t4.id})
        self._logger.debug('then 8')
        self.assertIn(items[0], {self.t2, self.t3, self.t4})
        self._logger.debug('then 9')
        self.assertIn(items[1].id, {self.t2.id, self.t3.id, self.t4.id})
    ...
    def test_get_paginated_tasks_filtered_by_tag_tag2_page_1(self):
        ...
        self.assertEqual(1, len(items))
        self.assertIn(items[0].id, {self.t2.id, self.t3.id, self.t4.id})
        self.assertEqual(self.t3, items[0])


class PaginatedTasksNullTasksPerPageTest(PersistenceLayerTestBase):
    def setUp(self):
        super().setUp()
        self.pl.save(self.pl.create_task('t1'))
        self.pl.save(self.pl.create_task('t2'))
        self.pl.save(self.pl.create_task('t3'))
        self.pl.save(self.pl.create_task('t4'))
        self.pl.save(self.pl.create_task('t5'))
        self.pl.save(self.pl.create_task('t6'))
        self.pl.save(self.pl.create_task('t7'))
        self.pl.save(self.pl.create_task('t8'))
        self.pl.save(self.pl.create_task('t9'))
        self.pl.save(self.pl.create_task('t10'))
        self.pl.save(self.pl.create_task('t11'))
        self.pl.save(self.pl.create_task('t12'))
        self.pl.save(self.pl.create_task('t13'))
        self.pl.save(self.pl.create_task('t14'))
        self.pl.save(self.pl.create_task('t15'))
        self.pl.save(self.pl.create_task('t16'))
        self.pl.save(self.pl.create_task('t17'))
        self.pl.save(self.pl.create_task('t18'))
        self.pl.save(self.pl.create_task('t19'))
        self.pl.save(self.pl.create_task('t20'))
        self.pl.save(self.pl.create_task('t21'))
