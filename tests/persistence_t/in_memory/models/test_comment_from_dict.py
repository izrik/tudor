...
class CommentFromDictTest(unittest.TestCase):
    def test_empty_yields_empty_dbcomment(self):
        # when
        result = Comment.from_dict({})
        # then
    ...
    def test_id_none_is_ignored(self):
        # when
        result = Comment.from_dict({'id': None})
        # then
        self.assertIsInstance(result, Comment)
        self.assertIsNone(result.id)
    ...
    def test_valid_id_gets_set(self):
        # when
        result = Comment.from_dict({'id': 123})
        # then
        self.assertIsInstance(result, Comment)
    ...
    def test_content_none_is_ignored(self):
        # when
        result = Comment.from_dict({'content': None})
        # then
        self.assertIsInstance(result, Comment)
        self.assertIsNone(result.content)
    ...
    def test_valid_content_gets_set(self):
        # when
        result = Comment.from_dict({'content': 'abc'})
        # then
        self.assertIsInstance(result, Comment)
    ...
    def test_timestamp_none_becomes_none(self):
        # when
        result = Comment.from_dict({'timestamp': None})
        # then
        self.assertIsInstance(result, Comment)
        self.assertIsNone(result.timestamp)
    ...
    def test_valid_timestamp_gets_set(self):
        # when
        result = Comment.from_dict({'timestamp': datetime(2017, 1, 1)})
        # then
        self.assertIsInstance(result, Comment)
    ...
    def test_task_none_is_ignored(self):
        # when
        result = Comment.from_dict({'task': None})
        # then
        self.assertIsInstance(result, Comment)
        self.assertIsNone(result.task)
    ...
    def test_valid_task_gets_set(self):
        ...
        task = Task('task')
        # when
        result = Comment.from_dict({'task': task})
        # then
        self.assertIsInstance(result, Comment)
    ...
    def test_task_id_none_is_ignored(self):
        # when
        result = Comment.from_dict({'task_id': None})
        # then
        self.assertIsInstance(result, Comment)
    ...
    def test_valid_task_id_is_ignored(self):
        ...
        task = Task('task')
        # when
        result = Comment.from_dict({'task_id': task.id})
        # then
        self.assertIsInstance(result, Comment)
        self.assertIsNone(result.task_id)
    ...
    def test_non_int_task_id_is_ignored(self):
        ...
        task = Task('task')
        # when
        result = Comment.from_dict({'task_id': task})
        # then
        self.assertIsInstance(result, Comment)
        self.assertIsNone(result.task_id)
        self.assertIsNone(result.task)
